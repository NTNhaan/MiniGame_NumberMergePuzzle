...
public static class DataConfig
{
    ...
    public static readonly int[] ALLOWED_VALUES = { 2, 4, 8, 16, 32 };
    public static readonly Color DEFAULT_TILE_COLOR = new Color(1f, 0.2f, 0.6f); // hồng
    ...
    public const float TILE_MOVE_DURATION = 0.35f;       // nếu không dùng constant speed
